...
class Desafio02
{
    static void Main()
    {
        int chico = 300 * Parse(Console.ReadLine());
        int bento = 1500 * Parse(Console.ReadLine());
        int bernardo = 600 * Parse(Console.ReadLine());
        int marina = 1000 * Parse(Console.ReadLine());
        int iara = 150 * Parse(Console.ReadLine());
        int marlene = 225;
        int total = chico + bento + bernardo + marina + iara + marlene;
        WriteLine($"Marlene, esse ano você precisa fazer {total} gramas de mandioca");
    }
}